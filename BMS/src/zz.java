...
public class dd extends JFrame {
   ...
   public dd() {
      ...
      panel_5.setLayout(new MigLayout("", "[grow]", "[555.00,grow][grow]"));
      
      JPanel panel_15 = new JPanel();
      panel_5.add(panel_15, "cell 0 0,grow");
      panel_15.setLayout(null);
      
      JTextPane textPane_21 = new JTextPane();
      textPane_21.setText("회원정보");
      textPane_21.setFont(new Font("굴림", Font.PLAIN, 14));
      textPane_21.setBounds(22, 10, 62, 23);
      panel_15.add(textPane_21);
      
      JTextPane textPane_22 = new JTextPane();
      textPane_22.setText("도서정보");
      textPane_22.setFont(new Font("굴림", Font.PLAIN, 14));
      textPane_22.setBounds(22, 280, 62, 23);
      panel_15.add(textPane_22);
      
      JPanel panel_17 = new JPanel();
      panel_17.setLayout(null);
      panel_17.setBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null));
      panel_17.setBackground(Color.WHITE);
      panel_17.setBounds(12, 21, 548, 249);
      panel_15.add(panel_17);
      
      JTextPane textPane_23 = new JTextPane();
      textPane_23.setText("회원번호");
      textPane_23.setBounds(12, 32, 54, 21);
      panel_17.add(textPane_23);
      
      textField_4 = new JTextField();
      textField_4.setColumns(10);
      textField_4.setBounds(79, 32, 187, 21);
      panel_17.add(textField_4);
      
      JTextPane textPane_24 = new JTextPane();
      textPane_24.setText("회원명");
      textPane_24.setBounds(280, 32, 42, 21);
      panel_17.add(textPane_24);
      
      JTextPane textPane_25 = new JTextPane();
      textPane_25.setText("전화번호");
      textPane_25.setBounds(12, 63, 54, 21);
      panel_17.add(textPane_25);
      
      textField_13 = new JTextField();
      textField_13.setColumns(10);
      textField_13.setBounds(79, 63, 187, 21);
      panel_17.add(textField_13);
      
      JTextPane textPane_26 = new JTextPane();
      textPane_26.setText("메      모");
      textPane_26.setBounds(12, 96, 54, 21);
      panel_17.add(textPane_26);
      
      textField_14 = new JTextField();
      textField_14.setColumns(10);
      textField_14.setBounds(334, 32, 187, 21);
      panel_17.add(textField_14);
      
      JScrollPane scrollPane_5 = new JScrollPane();
      scrollPane_5.setBounds(79, 98, 443, 137);
      panel_17.add(scrollPane_5);
      
      JButton btnNewButton_1 = new JButton("검색");
      btnNewButton_1.setBounds(334, 61, 187, 23);
      ...
      panel_18.setBounds(12, 294, 548, 298);
      panel_15.add(panel_18);
      
      JScrollPane scrollPane_6 = new JScrollPane();
      scrollPane_6.setBounds(79, 88, 443, 137);
      panel_18.add(scrollPane_6);
      
      JTextPane textPane_27 = new JTextPane();
      textPane_27.setText("메      모");
      textPane_27.setBounds(12, 86, 54, 21);
      panel_18.add(textPane_27);
      
      textField_15 = new JTextField();
      textField_15.setColumns(10);
      textField_15.setBounds(79, 55, 187, 21);
      panel_18.add(textField_15);
      
      JTextPane textPane_28 = new JTextPane();
      textPane_28.setText("저자");
      textPane_28.setBounds(12, 55, 54, 21);
      panel_18.add(textPane_28);
      
      JTextPane textPane_29 = new JTextPane();
      textPane_29.setText("도서번호");
      textPane_29.setBounds(12, 24, 54, 21);
      panel_18.add(textPane_29);
      
      textField_16 = new JTextField();
      textField_16.setColumns(10);
      textField_16.setBounds(79, 24, 187, 21);
      panel_18.add(textField_16);
      
      textField_17 = new JTextField();
      textField_17.setColumns(10);
      textField_17.setBounds(334, 24, 187, 21);
      panel_18.add(textField_17);
      
      textField_18 = new JTextField();
      textField_18.setColumns(10);
      textField_18.setBounds(334, 55, 187, 21);
      panel_18.add(textField_18);
      
      JTextPane textPane_30 = new JTextPane();
      textPane_30.setText("출판사");
      textPane_30.setBounds(280, 55, 42, 21);
      panel_18.add(textPane_30);
      
      JTextPane textPane_31 = new JTextPane();
      textPane_31.setText("도서명");
      textPane_31.setBounds(280, 24, 42, 21);
      panel_18.add(textPane_31);
      
      JButton btnNewButton_2 = new JButton("저장");
      btnNewButton_2.setBounds(425, 249, 97, 23);
      panel_18.add(btnNewButton_2);
      
      JButton btnNewButton_3 = new JButton("검색");
      btnNewButton_3.setBounds(316, 249, 97, 23);
      panel_18.add(btnNewButton_3);
      
      JPanel panel_16 = new JPanel();
      panel_5.add(panel_16, "cell 0 1,grow");
